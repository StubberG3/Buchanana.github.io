...
$(document).ready(function () {
  ...
  const handleLoadComplete = () => {
    ...
    $loadingText.setAttribute("style", "color: #36a491;");
    $loadingText.innerText = "Complete!";

    // transition to next pixel angie animation
    const $PixelAngie = document.getElementById("PixelAngie");
    $PixelAngie.className = "hithere";
    ...
    $("#loading").animate(
      ...
      2000
    ); // fade out over 2 seconds (2000 milliseconds)
    ...
    $(".spline-wrap").animate(
      ...
      2000
    ); // fade in over 2 seconds (2000 milliseconds)

    setTimeout(() => $("#loading").hide(), 2000); // hide loading after 2 seconds
  };
